...
Usage:
    python ml/datasets/download_xenocanto_data.py --api-key YOUR_KEY --max-per-class 50
    python ml/datasets/download_xenocanto_data.py --api-key YOUR_KEY --query "Psittacidae" --output ml/datasets/audio/
...
def main():
    ...
    parser.add_argument("--output", default="ml/datasets/audio", help="Output directory")
    ...
    if total > 0:
        ...
        print("   python ml/training/batch_extract_features.py --input-dir ml/datasets/audio --output /tmp/training_data.csv")
        print("2. Retrain model:")
        print("   python ml/training/train_model.py --epochs 50")
