...
Usage:
    python ml/training/train_model.py [--epochs 50] [--batch-size 32]
...
DEFAULT_MODEL_PATH = PROJECT_ROOT / "ml" / "models" / "audio_classifier.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default=str(DEFAULT_MODEL_PATH), help="Model save path")
